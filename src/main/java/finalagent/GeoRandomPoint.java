...
public class GeoRandomPoint {
    ...
    private static final double EARTH_RADIUS = 6371000; // en mètres
    private static final Random random = new Random();

    // Haversine — distance entre deux points (en mètres)
    ...
    //  Méthode simplifiée (plate) pour petits rayons
    ...
    // Méthode sphérique pour grands rayons
    ...
    //  Choix automatique : plate si <1 km, sinon sphérique
    ...
    public static void main(String[] args) {
        ...
        double[] radii = {20, 500, 1500, 3000}; // différents tests
        ...
        for (double radius : radii) {
            ...
            System.out.printf("   ➤ Distance réelle : %.2f m\n", d);
        }
    }
}
